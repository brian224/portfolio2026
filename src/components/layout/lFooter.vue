...
| 裝置 | 定位方式 | 位置 |
|------|----------|------|
| 手機（`m:`） | `fixed` | 緊貼底部，藍底（`#5894DD`）加上下內距 |
| 平板（`t:`） | `absolute` | 距底部 5px |
| 桌機（`p:`） | `absolute` | 緊貼底部 |
...
<template>
  <footer
    class="l-footer z-[4] w-full text-center m:fixed m:bottom-0 m:bg-[#5894DD] m:py-[5px] t:bottom-[5px] pt:absolute p:bottom-0"
  >
